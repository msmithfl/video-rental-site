  ...
  return (
    <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <div className="bg-[#202020] rounded-lg shadow-2xl backdrop-blur-sm p-8">
        ...
        <p className="text-lg text-gray-300 mb-6">5050 Town Center Circle, Boca Raton, FL 33486</p>
        <h3 className="text-2xl font-bold text-white mb-2">Rental Hours</h3>
        <p className="text-lg text-gray-300 mb-6">Saturday: 8pm - 5pm</p>
        ...
        <p className="text-lg text-gray-300">5050 Town Center Circle, Boca Raton, FL 33486</p>
        <p className="text-lg text-gray-300 mb-6">Mon - Sun: 8pm - 5pm</p>
